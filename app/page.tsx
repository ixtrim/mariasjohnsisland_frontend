...
const galleryImages = [
  ...
  { src: "/images/food-2.jpg", alt: "Margaritas" },
  ...
  { src: "/images/food-6.jpg", alt: "Churros" },
  { src: "/images/drinks-2.jpg", alt: "Classic Margarita" },
];
    ...
    <>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div ref={welcomeRef} className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="animate-item font-[family-name:var(--font-dancing)] text-4xl md:text-5xl lg:text-6xl text-[#1c0301] mb-8">
              {"Maria's Mexican Grill"}
            </h2>
            
            <p className="animate-item text-lg md:text-xl text-[#1c0301]/70 leading-relaxed">
            ...
            <p className="animate-item text-lg md:text-xl text-[#1c0301]/70 leading-relaxed mt-6">
      ...
      <section className="py-20 bg-[#dbf2fa] relative">
        <div className="container mx-auto px-4">
          ...
          <ImageGallery images={galleryImages} variant="slider" className="max-w-6xl mx-auto" />
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="menu-image relative">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1c0301]/30 to-transparent" />
              </div>
              {/* Decorative elements */}
            ...
            <div className="menu-content">
              ...
              <h2 className="font-[family-name:var(--font-dancing)] text-4xl md:text-5xl lg:text-6xl text-[#1c0301] mb-8">
                Our Menu
              </h2>
              
              <p className="text-lg text-[#1c0301]/70 leading-relaxed mb-6">
              ...
              <p className="text-lg text-[#1c0301]/70 leading-relaxed mb-10">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/menu"
                  className="btn-animated inline-flex items-center gap-2 px-8 py-4 bg-[#00a9e4] text-white rounded-full font-semibold text-sm uppercase tracking-wide shadow-lg shadow-[#00a9e4]/30"
                >
                  View Full Menu
                ...
                <Link
                  href="/happy-hour"
                  className="btn-animated inline-flex items-center gap-2 px-8 py-4 border-2 border-[#00a9e4] text-[#00a9e4] hover:bg-[#00a9e4] hover:text-white rounded-full font-semibold text-sm uppercase tracking-wide transition-colors duration-300"
                >
                  Happy Hour
                </Link>
              </div>
      ...
      {/* Quick Info Section */}
      <section className="py-20 bg-[#1c0301] text-white relative overflow-hidden">
        ...
        <div ref={infoRef} className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-3 gap-10 text-center">
            ...
            <div className="info-card flex flex-col items-center p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#00a9e4]/50 transition-all duration-500 hover:transform hover:scale-105">
              <div className="w-20 h-20 rounded-full bg-[#00a9e4]/20 flex items-center justify-center mb-6 pulse-glow">
      ...
      <section className="py-24 bg-[#c1eaf9] relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="font-[family-name:var(--font-dancing)] text-4xl md:text-5xl text-[#1c0301] mb-6">
              Ready to Experience Authentic Mexican Flavors?
            </h2>
            <p className="text-lg text-[#1c0301]/70 mb-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="btn-animated inline-flex items-center gap-2 px-10 py-5 bg-[#00a9e4] text-white rounded-full font-semibold text-sm uppercase tracking-wide shadow-xl shadow-[#00a9e4]/30"
              >
                Order Online
              ...
              <Link
                href="/location"
                className="btn-animated inline-flex items-center gap-2 px-10 py-5 bg-[#1c0301] text-white rounded-full font-semibold text-sm uppercase tracking-wide shadow-xl shadow-[#1c0301]/30"
              >
                Get Directions
